...
class Test_1(unittest.TestCase):
    ...
    def test_se_even(self):
        (x, y) = move(2, 1, "se")
        self.assertEquals(3, x)
        self.assertEquals(2, y)

    def test_se_odd(self):
        (x, y) = move(1, 1, "se")
        self.assertEquals(2, x)
        self.assertEquals(1, y)


    def test_sw_even(self):
        (x, y) = move(2, 1, "sw")
        self.assertEquals(1, x)
        self.assertEquals(2, y)


    def test_sw_odd(self):
        (x, y) = move(1, 1, "sw")
        self.assertEquals(0, x)
        self.assertEquals(1, y)

    def test_nw_even(self):
        (x, y) = move(2, 1, "nw")
        self.assertEquals(1, x)
        self.assertEquals(1, y)

    def test_nw_odd(self):
        (x, y) = move(1, 1, "nw")
        self.assertEquals(0, x)
        self.assertEquals(0, y)
